...
App.Collection.TransactionList = Backbone.Collection.extend({
	...
	url : "https://www.gahk.dk/nyintern/oelkaelder/purchase"
...
App.Collection.AlumneList = Backbone.Collection.extend({
	...
	url : "https://www.gahk.dk/index.php/nyintern/oelkaelder/activeShoppers"
...
App.Collection.ProductList = Backbone.Collection.extend({
    ...
    url : "https://www.gahk.dk/index.php/nyintern/oelkaelder/products",
...
var counter = function(){
	...
	setTimeout(counter, 10000); // check again in 10 seconds
}
