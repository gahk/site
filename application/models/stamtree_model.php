...
class Stamtree_model extends CI_Model {
	...
	function getAllAlumner(){

		//	$query =  $this->db->query("
		//	SELECT ID,firstName,lastName,fylgje,moveInDay FROM intern_alumne ORDER by moveInDay ASC");
			$query =  $this->db->query("
			SELECT ID,CONCAT_WS(' ',firstName,lastName) as name,fylgje,moveInDay FROM intern_alumne ORDER by moveInDay ASC");
     return $query->result();
